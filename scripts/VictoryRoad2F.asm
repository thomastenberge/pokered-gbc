...
; Sprite11 indexes the 1st boulder, and ($01, $10) are the 1st swtich's coordinates.
	...
	ld [hl], a
	ld hl, wShadowOAMSprite11XCoord
	ld a, $01
	add 4; wispnote - We need to offset coordinates by 4
	ld [hl], a
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;	
...
; therefore, there is no need to check.
	ld hl, wShadowOAMSprite13YCoord
	ld a, $10
	add 4; wispnote - We need to offset coordinates by 4
	ld [hl], a
	ld hl, wShadowOAMSprite13XCoord
	ld a, $09
	add 4; wispnote - We need to offset coordinates by 4
	ld [hl], a
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
VictoryRoad2FDefaultScript:
	...
	ld a, [wCoordIndex]
	cp $2
	jr z, .second_switch ; wispnote - Jump if the boulder is on the second coordinates.
