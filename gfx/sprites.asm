...
BrunoSprite::            INCBIN "gfx/sprites/bruno.2bpp"	; Lorelei and Bruno moved from "NPC Sprites 2" to 
LoreleiSprite::          INCBIN "gfx/sprites/lorelei.2bpp"	; here, to make room for girl player sprite
