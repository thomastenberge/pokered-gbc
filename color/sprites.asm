...
SpritePaletteAssignments: ; Characters on the overworld
	...
	; 0x47: SPRITE_PAPER_SHEET
	db SPR_PAL_BROWN

	; 0x48: SPRITE_BOOK_MAP_DEX
	db SPR_PAL_ORANGE

	; 0x49: SPRITE_CLIPBOARD
	db SPR_PAL_BROWN

	; 0x50: SPRITE_SNORLAX
	db SPR_PAL_ORANGE

	; 0x51: SPRITE_OLD_AMBER_COPY
	db SPR_PAL_ROCK

	; 0x52: SPRITE_OLD_AMBER
	db SPR_PAL_ROCK

	; 0x53: SPRITE_LYING_OLD_MAN_UNUSED_1
	db SPR_PAL_BROWN

	; 0x54: SPRITE_LYING_OLD_MAN_UNUSED_2
	db SPR_PAL_BROWN

	; 0x55: SPRITE_LYING_OLD_MAN
	db SPR_PAL_BROWN
