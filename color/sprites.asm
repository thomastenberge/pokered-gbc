...
SpritePaletteAssignments: ; Characters on the overworld
	...
	; 0x49: SPRITE_PAPER_SHEET
	db SPR_PAL_BROWN

	; 0x4a: SPRITE_BOOK_MAP_DEX
	db SPR_PAL_ORANGE

	; 0x4b: SPRITE_CLIPBOARD
	db SPR_PAL_BROWN

	; 0x4c: SPRITE_SNORLAX
	db SPR_PAL_ORANGE

	; 0x4d: SPRITE_OLD_AMBER_COPY
	db SPR_PAL_ROCK

	; 0x4e: SPRITE_OLD_AMBER
	db SPR_PAL_ROCK

	; 0x4f: SPRITE_LYING_OLD_MAN_UNUSED_1
	db SPR_PAL_BROWN

	; 0x50: SPRITE_LYING_OLD_MAN_UNUSED_2
	db SPR_PAL_BROWN

	; 0x51: SPRITE_LYING_OLD_MAN
	db SPR_PAL_BROWN
